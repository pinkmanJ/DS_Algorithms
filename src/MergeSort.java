...
public class MergeSort {
	...
	public static void merge(int[] inputArr, int start, int mid, int end) {
		...
		//optimization, remember the left and right arrays are sorted at this point, so if the last
		//element in the left array is less than or equal to the first element in the right array, we
